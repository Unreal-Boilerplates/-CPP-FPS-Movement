 ...
 */
class CPPTEMPLATE_API IShooterWeaponHolder
{
	GENERATED_BODY()
...
public:
	...
	/** Sets the current offset applied to the owner's hands/arms mesh, used to animate simple weapon sequences like reloading */
	virtual void SetHandsOffset(const FVector& Offset) = 0;
